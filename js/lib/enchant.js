 ...
 * @type {Object}
 * @namespace
 * {@link enchant.Tween} ã‚¯ãƒ©ã‚¹ã§ç”¨ã„ã‚‹ã‚¤ãƒ¼ã‚¸ãƒ³ã‚°é–¢æ•°ã®ãƒ©ã‚¤ãƒ–ãƒ©ãƒªåå‰ç©ºé–“.
 */
enchant.Easing = {
    /**
     * @param t
...
enchant.Timeline = enchant.Class.create(enchant.EventTarget, {
     ...
     *
     Â Â Â Â  * Reading a tl.enchant.js, all classes (Group, Scene, Entity, Label, Sprite) of the Node class that inherits
     Â Â Â Â  * Tlthe property, an instance of the Timeline class is generated.
